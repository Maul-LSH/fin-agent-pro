...
它把公开市场数据、量化风险模型、交易行为优先的市场热力图、板块级 AI 分析、多视角估值上下文、投资组合诊断和 LLM 报告整合在一起，同时始终区分“数据真正支持了什么”和“哪些部分仍然未知”。
...
**市场背景 -> 公司基本面 -> 风险模型 -> 估值上下文 -> AI 解读 -> 明确不确定性 -> 可导出报告**
...
| **估值上下文** | 10 年两阶段 DCF，加上 WACC、反向隐含增长、Forward P/E、PEG、EV/Sales、EV/Revenue Growth、利润率趋势和华尔街目标价共识。 |
