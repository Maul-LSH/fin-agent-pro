...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  en: {
    ...
    dcfIntroTitle: "Build a DCF as a scenario map, not a price prophecy.",
    dcfIntroBody: "Set the discount rate, growth path, and terminal growth, then compare intrinsic value with market price, analyst targets, multiples, and margin quality.",
    dcfIntroModelTitle: "DCF model",
    dcfIntroModelBody: "The model projects free cash flow, discounts it with WACC, and calculates per-share intrinsic value.",
    ...
    dcfIntroFlow1: "Select ticker and assumptions",
    dcfIntroFlow2: "Run DCF and sensitivity analysis",
    dcfIntroFlow3: "Read valuation context full page",
    dcfIntroExampleLabel: "Example calculation path",
    dcfIntroExampleStep1: "Discount rate",
    dcfIntroExampleStep2: "Projected cash flow",
    dcfIntroExampleStep3: "Intrinsic value",
    dcfIntroExampleOutput: "What users get",
    dcfIntroFormulaBody: "The model forecasts future free cash flow, discounts each year with WACC, adds terminal value, subtracts net debt, and divides by shares outstanding.",
    ...
    dcfIntroExampleBody: "Users get three anchors in one place: our DCF scenario, the current market price, and Wall Street target consensus, plus the assumptions and data sources behind the calculation.",
    riskLow: "Low Risk",
  ...
  zh: {
    ...
    dcfIntroTitle: "把 DCF 当成情景地图，而不是价格预言。",
    dcfIntroBody: "设置折现率、增长路径和永续增长，再把内在价值与市场价、分析师目标价、估值倍数和利润率质量放在一起看。",
    dcfIntroModelTitle: "DCF 模型",
    dcfIntroModelBody: "模型预测自由现金流，使用 WACC 折现，并计算每股内在价值。",
    ...
    dcfIntroFlow1: "选择 ticker 和假设参数",
    dcfIntroFlow2: "运行 DCF 与敏感性分析",
    dcfIntroFlow3: "整页阅读估值上下文",
    dcfIntroExampleLabel: "示例计算路径",
    dcfIntroExampleStep1: "折现率",
    dcfIntroExampleStep2: "预测现金流",
    dcfIntroExampleStep3: "内在价值",
    dcfIntroExampleOutput: "用户得到什么",
    dcfIntroFormulaBody: "模型会预测未来自由现金流，用 WACC 折现每一年的现金流，加上终值，扣除净债务，再除以流通股数得到每股内在价值。",
    ...
    dcfIntroExampleBody: "用户最终会同时得到三个锚点：我们的 DCF 情景、当前市场价格、华尔街目标价共识，以及背后的假设和数据来源。",
    riskLow: "低风险",
    riskMedium: "中等风险",
    riskHigh: "高风险",
